        ...
        <div id="AgregarEjercicioPage">
            <div id = "AgregarEjercicioBox">
                <div id = "inputsEjerciciosBox">
                    <div id="agregarEjercicioTitulo"><h1>Agregar ejercicio</h1> <img id="pesaImg" src={pesa} alt="" /></div>
                    ...
                    <div id="agregarEjercicioBtnBox"><button id="agregarEjercicioBtn">Agregar</button></div>
                </div>
            </div>
        <Flecha></Flecha>
